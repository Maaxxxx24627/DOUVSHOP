...
namespace Project7 {
	...
	private: NS_Comp_Svc::CLClientService^ oSvc;
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->dataGridView1->Location = System::Drawing::Point(256, 37);
			this->dataGridView1->Name = L"dataGridView1";
			this->dataGridView1->Size = System::Drawing::Size(858, 298);
			...
			// button2
			// 
			this->button2->Location = System::Drawing::Point(256, 385);
			...
			// button3
			// 
			this->button3->Location = System::Drawing::Point(256, 466);
			...
			this->button4->Location = System::Drawing::Point(256, 561);
			...
			// textBox1
			// 
			this->textBox1->Location = System::Drawing::Point(935, 378);
			...
			// textBox2
			// 
			this->textBox2->Location = System::Drawing::Point(935, 429);
			...
			// textBox3
			// 
			this->textBox3->Location = System::Drawing::Point(935, 472);
			...
			// textBox4
			// 
			this->textBox4->Location = System::Drawing::Point(935, 515);
			...
			// textBox5
			// 
			this->textBox5->Location = System::Drawing::Point(935, 566);
			...
			// textBox6
			// 
			this->textBox6->Location = System::Drawing::Point(935, 611);
			this->textBox6->Name = L"textBox6";
			this->textBox6->Size = System::Drawing::Size(179, 20);
			this->textBox6->TabIndex = 10;
			this->textBox6->TextChanged += gcnew System::EventHandler(this, &MyForm5::textBox6_TextChanged);
			// 
			// label1
			// 
			this->label1->AutoSize = true;
			this->label1->Location = System::Drawing::Point(592, 385);
			this->label1->Name = L"label1";
			this->label1->Size = System::Drawing::Size(244, 13);
			this->label1->TabIndex = 11;
			this->label1->Text = L"Entrez un numero client (seulement pour modifier) :";
			// 
			// label2
			// 
			this->label2->AutoSize = true;
			this->label2->Location = System::Drawing::Point(592, 432);
			...
			this->label3->Location = System::Drawing::Point(592, 476);
			this->label3->Name = L"label3";
			this->label3->Size = System::Drawing::Size(97, 13);
			this->label3->TabIndex = 13;
			this->label3->Text = L"Entrez un Prénom :";
			// 
			// label4
			// 
			this->label4->AutoSize = true;
			this->label4->Location = System::Drawing::Point(592, 518);
			this->label4->Name = L"label4";
			this->label4->Size = System::Drawing::Size(172, 13);
			this->label4->TabIndex = 14;
			this->label4->Text = L"Entrez une adresse de facturation :";
			// 
			// label5
			// 
			this->label5->AutoSize = true;
			this->label5->Location = System::Drawing::Point(592, 561);
			this->label5->Name = L"label5";
			this->label5->Size = System::Drawing::Size(160, 13);
			this->label5->TabIndex = 15;
			this->label5->Text = L"Entrez une adresse de livraison :";
			// 
			// label6
			// 
			this->label6->AutoSize = true;
			this->label6->Location = System::Drawing::Point(592, 611);
			this->label6->Name = L"label6";
			this->label6->Size = System::Drawing::Size(244, 13);
			this->label6->TabIndex = 16;
			this->label6->Text = L"Entrez une date de naissance (DD/ MM/ YYYY) : ";
			this->label6->Click += gcnew System::EventHandler(this, &MyForm5::label6_Click);
			// 
			// pictureBox1
			// 
			this->pictureBox1->Image = (cli::safe_cast<System::Drawing::Image^>(resources->GetObject(L"pictureBox1.Image")));
			this->pictureBox1->Location = System::Drawing::Point(1373, 37);
			...
			this->panel1->Location = System::Drawing::Point(0, 783);
			this->panel1->Name = L"panel1";
			this->panel1->Size = System::Drawing::Size(1602, 31);
			...
			this->ClientSize = System::Drawing::Size(1602, 814);
...
#pragma endregion
	...
	private: System::Void MyForm5_Load(System::Object^ sender, System::EventArgs^ e) {
		oSvc = gcnew NS_Comp_Svc::CLClientService();
		oDs = gcnew System::Data::DataSet();
		oDs = oSvc->selectionnerToutsLesClients("Client");
		dataGridView1->DataSource = oDs->Tables["Client"];
		oDs->Tables["Client"]->PrimaryKey = gcnew array<System::Data::DataColumn^>{ oDs->Tables["Client"]->Columns["Client"] };

	}
	private: System::Void button2_Click(System::Object^ sender, System::EventArgs^ e) {
		this->oSvc->ajouterUnClient(this->textBox2->Text, this->textBox3->Text, this->textBox4->Text, this->textBox5->Text, this->textBox6->Text);

	}
private: System::Void textBox1_TextChanged(System::Object^ sender, System::EventArgs^ e) {
}
private: System::Void button3_Click(System::Object^ sender, System::EventArgs^ e) {
	this->oSvc->modifierUnClient(System::Convert::ToInt32(this->textBox1->Text), this->textBox2->Text, this->textBox3->Text, this->textBox4->Text, this->textBox5->Text, this->textBox6->Text);
}
...
private: System::Void button4_Click(System::Object^ sender, System::EventArgs^ e) {
	if (dataGridView1->SelectedRows->Count > 0) {
		...
		int idToDelete = (int)dataGridView1->Rows[selectedIndex]->Cells["numeroClient"]->Value;

		oDs->Tables["Client"]->Rows->RemoveAt(selectedIndex);


		oSvc->supprimerUnClient(idToDelete);
